...
class ROSDesiredPositionGenerator(object):
    ...
    #     zigzag_intpoints = 6
    #     scale_factor = 0.75;
    #     zigzag_start = scale_factor*np.array([[-2, 2, 2, -np.pi]])]])  
    #     zigzag_end = scale_factor*np.array([[-2, -2, 2, -np.pi]])
    ...
    #     zigzag_end_2 = scale_factor*np.array([[-1, -2, 2, -np.pi]])
    ...
    #     zigzag_end_3 = scale_factor*np.array([[-1, 2, 2, -np.pi]])
    ...
    #     zigzag_end_4 = scale_factor*np.array([[0, 2, 2, -np.pi]])
    ...
    #     zigzag_end_5 = scale_factor*np.array([[0, -2, 2, -np.pi]])
    ...
    #     zigzag_end_6 = scale_factor*np.array([[1, -2, 2, -np.pi]])
    ...
    #     zigzag_end_7 = scale_factor*np.array([[1, 2, 2, -np.pi]])
    ...
    #     zigzag_end_8 = scale_factor*np.array([[2, 2, 2, -np.pi]])
    ...
    #     zigzag_end_9 = scale_factor*np.array([[2, -2, 2, -np.pi]])
    ...
    final_trajectory = rrt.path_planner()
    ...
    def send_des_pos(self, event):
        ...
        msg_array = self.final_trajectory.flatten()
